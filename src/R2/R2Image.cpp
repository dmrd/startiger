...
void R2Image::AddNoise(double factor)
{
...
void R2Image::ApplyGamma(double exponent)
{
...
void R2Image::BlackAndWhite(void)
{
...
void R2Image::MotionBlur(int amount)
{
...
void R2Image::BilateralFilter(double rangesigma, double domainsigma)
{
...
void R2Image::Scale(double sx, double sy, int sampling_method)
{
...
void R2Image::Rotate(double angle, int sampling_method)
{
...
void R2Image::Fun(int sampling_method)
{
...
void R2Image::Composite(const R2Image& top, int operation)
{
...
void R2Image::CopyChannel(const R2Image& from_image, int from_channel, int to_channel)
{
...
void R2Image::Add(const R2Image& image)
{
...
void R2Image::Subtract(const R2Image& image)
{
...
void R2Image::Morph(const R2Image& target, 
