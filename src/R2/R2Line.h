...
inline double R2Line::A(void) const
{
...
inline double R2Line::B(void) const
{
...
inline double R2Line::C(void) const
{
...
inline R2Point R2Line::AnyPoint(void) const
{
...
inline R2Point R2Line::ClosestPoint(const R2Point& point) const
{
...
inline R2Vector R2Line::Vector(void) const
{
...
inline R2Vector R2Line::Normal(void) const
{
...
inline bool R2Line::operator==(const R2Line& line) const
{
