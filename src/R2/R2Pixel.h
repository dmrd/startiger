...
inline double R2Pixel::Red(void) const
{
...
inline double R2Pixel::Green(void) const
{
...
inline double R2Pixel::Blue(void) const
{
...
inline double R2Pixel::Alpha(void) const
{
...
inline double *R2Pixel::Components(void)
{
    // Return pixel array
    return c;
}
...
inline double R2Pixel::Component(int i) const
{
    assert((i>=0)&&(i<=3));
    return(c[i]);
}
...
inline double R2Pixel::operator[](int i) const
{
    return Component(i);
}
...
inline double& R2Pixel::operator[] (int i) 
{
    assert((i>=0)&&(i<=3));
    return(c[i]);
}
...
inline bool R2Pixel::IsBlack (void) const
{
...
inline bool R2Pixel::IsWhite (void) const
{
...
inline double R2Pixel::Luminance(void) const
{
    // Return luminance
...
inline void R2Pixel::SetRed(double red)
{
    // Set red component
    c[0] = red;
}
...
inline void R2Pixel::SetGreen(double green)
{
    // Set green component
    c[1] = green;
}
...
inline void R2Pixel::SetBlue(double blue)
{
    // Set blue component
    c[2] = blue;
}
...
inline void R2Pixel::SetAlpha(double alpha)
{
    // Set alpha component
    c[3] = alpha;
}
...
inline void R2Pixel::Reset (double red, double green, double blue, double alpha)
{
    // Set all components
    c[0] = red;
    c[1] = green;
...
inline void R2Pixel::Clamp(double maximum_value)
{
    // Set all components
...
inline R2Pixel::R2Pixel(const R2Pixel& pixel)
{
    // Copy components 
    c[0] = pixel.c[0];
    c[1] = pixel.c[1];
...
inline R2Pixel::R2Pixel(double red, double green, double blue, double alpha)
{
    // Set components 
    c[0] = red; 
    c[1] = green; 
...
inline R2Pixel::R2Pixel(const double rgba[4])
{
    // Set components 
    c[0] = rgba[0]; 
    c[1] = rgba[1]; 
...
inline bool R2Pixel::operator==(const R2Pixel& pixel) const
{
...
inline R2Pixel& R2Pixel::operator=(const R2Pixel& pixel)
{
    // Copy components
    c[0] = pixel.c[0];
    c[1] = pixel.c[1];
...
inline R2Pixel& R2Pixel::operator*=(double a)
{
    c[0] *= a;
    c[1] *= a;
    c[2] *= a;
