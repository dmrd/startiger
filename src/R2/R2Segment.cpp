...
R2Segment::R2Segment(void)
{
}



R2Segment::R2Segment(const R2Segment& segment) :
    line(segment.line),
...
R2Segment::R2Segment(const R2Point& point, const R2Vector& vector)
{
...
R2Segment::R2Segment(const R2Point& point1, const R2Point& point2)
{
    Reset(point1, point2);
}
...
R2Segment::R2Segment(double x1, double y1, double x2, double y2)
{
...
void R2Segment::Project(const R2Line& projection_line)
{
...
void R2Segment::Mirror(const R2Line& mirror_line)
{
...
void R2Segment::Translate(const R2Vector& vector)
{
    // Translate segment
...
void R2Segment::Rotate(const R2Point& origin, double angle)
{
...
void R2Segment::Reset(const R2Point& point1, const R2Point& point2)
{
    // Reset segment
    points[0] = point1;
    points[1] = point2;
...
void R2Segment::SetPoint(const R2Point& point, int k)
{
    // Reset segment
    points[k] = point;
    R2Vector v(points[1] - points[0]);
...
R2Segment R2Segment::operator-(void)
{
...
void R2Segment::Print(FILE *fp) const
{
