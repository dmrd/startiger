...
inline R2Point R2Segment::operator[] (int k) const
{
...
inline R2Point R2Segment::Point (int k) const
{
    // Return kth endpoint of segment
    assert((k>=0)&&(k<=1));
    return points[k];
...
inline R2Point R2Segment::Start (void) const
{
...
inline R2Point R2Segment::End (void) const
{
...
inline R2Vector R2Segment::Vector(void) const
{
...
inline R2Vector R2Segment::Normal(void) const
{
...
inline R2Point R2Segment::Point(double t) const
{
...
inline R2Point R2Segment::Midpoint(void) const
{
...
inline R2Line R2Segment::Line(void) const
{
...
inline double R2Segment::Length(void) const
{
...
inline double R2Segment::T(const R2Point& point) const
{
...
inline bool R2Segment::IsPoint(void) const
{
...
inline bool R2Segment::operator==(const R2Segment& segment) const
{
...
inline void R2Segment::SetStart(const R2Point& point)
{
...
inline void R2Segment::SetEnd(const R2Point& point)
{
