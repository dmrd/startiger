...
R2Vector::R2Vector(void)
{
}



R2Vector::R2Vector(double x, double y)
{
    v[0] = x; 
    v[1] = y; 
}
...
R2Vector::R2Vector(const R2Vector& vector)
{
    v[0] = vector.v[0]; 
    v[1] = vector.v[1]; 
}
...
R2Vector::R2Vector(double array[2])
{
    v[0] = array[0]; 
    v[1] = array[1]; 
}
...
void R2Vector::Rotate(double angle)
{
...
void R2Vector::Mirror(const R2Line& line)
{
...
R2Vector& R2Vector::operator=(const R2Vector& vector)
{
    v[0] = vector.v[0];
    v[1] = vector.v[1];
    return *this;
...
R2Vector& R2Vector::operator*=(double a)
{
    v[0] *= a;
    v[1] *= a;
    return *this;
...
void R2Vector::Print(FILE *fp) const
{
