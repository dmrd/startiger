...
inline double R2Vector::X (void) const
{
    // Return X coordinate
    return v[0];
}
...
inline double R2Vector::Y (void) const
{
    // Return Y coordinate
    return v[1];
}
...
inline double R2Vector::operator[] (int dim) const
{
...
inline double& R2Vector::operator[] (int dim) 
{
    // Return X (dim=0) or Y (dim=1) coordinate
    return v[dim];
}
...
inline bool R2Vector::IsZero (void) const
{
...
inline bool R2Vector::IsNormalized (void) const
{
...
inline double R2Vector::Length(void) const
{
...
inline R2Point R2Vector::Point(void) const
{
...
inline int R2Vector::MaxDimension(void) const
{
...
inline bool R2Vector::operator==(const R2Vector& vector) const
{
...
inline double R2Vector::Dot(const R2Vector& vector) const
{
    return (v[0]*vector.v[0]) + (v[1]*vector.v[1]);
}
...
inline double R2Vector::Cross(const R2Vector& vector) const
{
...
inline void R2Vector::SetX (double x) 
{
    // Set X coord
    v[0] = x;
}
...
inline void R2Vector::SetY (double y) 
{
    // Set Y coord
    v[1] = y;
}
...
inline void R2Vector::SetCoord (int dim, double coord) 
{
    // Set coord
    assert ((dim>=0)&&(dim<=1));
    v[dim] = coord;
...
inline void R2Vector::Reset(double x, double y) 
{
    // Set all coords
    v[0] = x;
    v[1] = y;
