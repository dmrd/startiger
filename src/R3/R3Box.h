...
class R3Box : public R3Shape 
{
    public:
        R3Shape::Type GetType(void) { return R3Shape::BOX; }
        const R3Box BBox(void) const { return *this; }
...
inline R3Point& R3Box::operator[] (int dir) 
{
...
inline const R3Point& R3Box::operator[] (int dir) const
{
    // Return min or max point 
    return (dir == 0) ? minpt : maxpt;
}
...
inline const R3Point& R3Box::Min (void) const
{
...
inline const R3Point& R3Box::Max (void) const
{
...
inline double R3Box::XMin (void) const
{
...
inline double R3Box::YMin (void) const
{
...
inline double R3Box::ZMin (void) const
{
...
inline double R3Box::XMax (void) const
{
...
inline double R3Box::YMax (void) const
{
...
inline double R3Box::ZMax (void) const
{
...
inline double R3Box::Coord (int dir, int dim) const
{
...
inline bool R3Box::IsEmpty (void) const
{
...
inline double R3Box::AxisLength (const int axis) const
{
...
inline double R3Box::XLength (void) const
{
...
inline double R3Box::YLength (void) const
{
...
inline double R3Box::ZLength (void) const
{
...
inline double R3Box::AxisRadius (const int axis) const
{
...
inline double R3Box::XRadius (void) const
{
...
inline double R3Box::YRadius (void) const
{
...
inline double R3Box::ZRadius (void) const
{
...
inline double R3Box::DiagonalRadius (void) const
{
...
inline double R3Box::AxisCenter (const int axis) const
{
    // Return radius of Box along axis
    return 0.5 * (maxpt[axis] + minpt[axis]);
}
...
inline double R3Box::XCenter (void) const
{
...
inline double R3Box::YCenter (void) const
{
...
inline double R3Box::ZCenter (void) const
{
...
inline bool R3Box::operator==(const R3Box& box) const
{
