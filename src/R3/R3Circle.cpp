...
R3Circle::R3Circle(void)
{
}



    R3Circle::R3Circle(const R3Circle& circle)
    ...
    plane(circle.plane)
{
    ...
    R3Circle::R3Circle(const R3Point& center, double radius, const R3Vector& normal)
: center(center),
    radius(radius),
    plane(center, normal)
{
...
const double R3Circle::Area(void) const
{
...
const R3Box R3Circle::BBox(void) const
{
...
void R3Circle::Reposition(const R3Point& center) 
{
...
void R3Circle::Translate(const R3Vector& offset) 
{
    // Translate circle
...
void R3Circle::Align(const R3Vector& normal) 
{
...
void R3Circle::Resize(double radius)
{
    // Set radius
    this->radius = radius;
}
...
void R3Circle::Outline(void) const
{
    // Outline circle
    int nsteps = 16;
    R3Vector axis1 = R3zero_vector;
...
void R3Circle::Print(FILE *fp) const
{
    // Print parameters
