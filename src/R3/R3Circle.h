...
class R3Circle : public R3Shape
{
    public:
        R3Shape::Type GetType(void) { return R3Shape::CIRCLE; }
...
inline const R3Point& R3Circle::Center(void) const
{
...
inline const double R3Circle::Radius(void) const
{
...
inline const R3Plane& R3Circle::Plane(void) const
{
...
inline const R3Vector& R3Circle::Normal(void) const
{
...
inline const bool R3Circle::IsEmpty(void) const
{
