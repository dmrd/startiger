...
R3Cone::R3Cone(const R3Point& center, double radius, double height) :
    center(center),
    radius(radius),
    height(height)
{
...
double R3Cone::Volume(void) const
{
...
const R3Box R3Cone::BBox(void) const
{
...
void R3Cone::Translate(const R3Vector& vector)
{
    // Move cone 
...
void R3Cone::Reposition(const R3Point& center)
{
    // Set cone center
    this->center = center;
}
...
void R3Cone::Resize(double radius, double height) 
{
    // Set cone radius
    this->radius = radius;
    this->height = height;
...
void R3Cone::Outline(void) const
{
...
void R3Cone::Print(FILE *fp) const
{
