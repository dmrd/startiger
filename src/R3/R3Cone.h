...
class R3Cone : public R3Shape
{
    public:
        R3Shape::Type GetType(void) { return R3Shape::CONE; }
...
inline const R3Point& R3Cone::Center(void) const
{
    // Return center point
    return center;
}
...
inline double R3Cone::Radius(void) const
{
    // Return cone radius
    return radius;
}
...
inline double R3Cone::Height(void) const
{
    // Return cone height
    return height;
}
...
inline R3Segment R3Cone::Axis(void) const
{
    // Return cone axis
