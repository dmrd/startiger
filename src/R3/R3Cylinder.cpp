...
R3Cylinder::R3Cylinder(void)
{
}



R3Cylinder::R3Cylinder(const R3Cylinder& cylinder) :
...
R3Cylinder::R3Cylinder(const R3Point& center, double radius, double height) :
    center(center),
    radius(radius),
    height(height)
{
...
double R3Cylinder::Area(void) const
{
...
double R3Cylinder::Volume(void) const
{
...
const R3Box R3Cylinder::BBox(void) const
{
...
void R3Cylinder::Translate(const R3Vector& vector)
{
    // Move cylinder 
...
void R3Cylinder::Reposition(const R3Point& center)
{
    // Set cylinder center
    this->center = center;
}
...
void R3Cylinder::Resize(double radius, double height) 
{
    // Set cylinder radius
    this->radius = radius;
    this->height = height;
...
void R3Cylinder::Draw(void) const
{
    // Draw cylinder
    glPushMatrix();
...
void R3Cylinder::Outline(void) const
{
...
void R3Cylinder::Print(FILE *fp) const
{
