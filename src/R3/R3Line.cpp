...
R3Line::R3Line(const R3Line& line) :
    point(line.point),
    vector(line.vector)
{
}
...
R3Line::R3Line(const R3Point& point, const R3Vector& vector, bool normalized) :
    point(point),
    vector(vector)
{
    // Normalize vector
...
R3Line::R3Line(const R3Point& point1, const R3Point& point2) :
    point(point1),
...
R3Line::R3Line(double x1, double y1, double z1, double x2, double y2, double z2) :
    point(x1, y1, z1),
...
void R3Line::Transform(const R3Matrix& matrix)
{
...
void R3Line::InverseTransform(const R3Matrix& matrix)
{
    // Transform point and vector
...
bool R3Line::operator==(const R3Line& line) const
{
...
void R3Line::Print(FILE *fp) const
{
