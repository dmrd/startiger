...
R3Point R3Mesh::Center(void) const
{
...
double R3Mesh::Radius(void) const
{
...
void R3Mesh::Translate(double dx, double dy, double dz)
{
...
void R3Mesh::RandomNoise(double factor)
{
...
void R3Mesh::Inflate(double factor)
{
...
void R3Mesh::SmoothBilateral(void)
{
...
void R3Mesh::StarFaces(double factor)
{
...
void R3Mesh::SplitLongEdges(double max_edge_length)
{
...
void R3Mesh::CollapseShortEdges(double min_edge_length)
{
...
void R3Mesh::ClusterVertices(double grid_cell_size)
{
...
void R3Mesh::Bezier(const R3Mesh& control_mesh, int M, int N)
{
...
void R3Mesh::BSpline(const R3Mesh& control_mesh, int M, int N)
{
...
void R3Mesh::SubdivideLoop(void)
{
...
void R3Mesh::SubdivideCatmullClark(void)
{
...
void R3Mesh::FixCracks(double epsilon)
{
...
void R3Mesh::FixIntersections(void)
{
...
void R3Mesh::Intersect(const R3Mesh& mesh)
{
...
void R3Mesh::Subtract(const R3Mesh& mesh)
{
...
void R3Mesh::Union(const R3Mesh& mesh)
{
...
void R3Mesh::Crop(const R3Plane& plane)
{
...
R3MeshFace *R3Mesh::CreateFace(const vector<R3MeshVertex *>& vertices)
{
    // Create face
...
void R3Mesh::DeleteVertex(R3MeshVertex *vertex)
{
...
void R3Mesh::DeleteFace(R3MeshFace *face)
{
...
void R3Mesh::UpdateVertexNormals(void)
{
...
void R3Mesh::UpdateVertexCurvatures(void)
{
...
void R3Mesh::UpdateFacePlanes(void)
{
...
void R3Mesh::Outline(void) const
{
...
int R3Mesh::Write(const char *filename)
{
    // Parse input filename extension
    const char *extension;
...
int R3Mesh::ReadOff(const char *filename)
{
    // Open file
    FILE *fp;
...
int R3Mesh::WriteOff(const char *filename)
{
    // Open file
...
int R3Mesh::ReadRay(const char *filename)
{
    // Open file
    FILE *fp;
    if (!(fp = fopen(filename, "r")))
...
int R3Mesh::WriteRay(const char *filename)
{
    // Open file
    FILE *fp;
...
R3MeshVertex::R3MeshVertex(void) :
    position(0, 0, 0),
    normal(0, 0, 0),
    texcoords(0, 0),
    curvature(0),
...
R3MeshVertex::R3MeshVertex(const R3MeshVertex& vertex) :
...
R3MeshVertex::R3MeshVertex(const R3Point& position, const R3Vector& normal, const R2Point& texcoords) :
    position(position),                    
    normal(normal),
    texcoords(texcoords),
    curvature(0),
...
double R3MeshVertex::AverageEdgeLength(void) const
{
...
void R3MeshVertex::UpdateNormal(void)
{
...
void R3MeshVertex::UpdateCurvature(void)
{
...
R3MeshFace::R3MeshFace(const R3MeshFace& face) :
...
R3MeshFace::R3MeshFace(const vector<R3MeshVertex *>& vertices) :
    vertices(vertices),
    plane(0, 0, 0, 0),
    id(0)
{
...
double R3MeshFace::AverageEdgeLength(void) const
{
...
double R3MeshFace::Area(void) const
{
    // Check number of vertices
...
void R3MeshFace::UpdatePlane(void)
{
    // Check number of vertices
