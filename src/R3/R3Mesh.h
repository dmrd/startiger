...
struct R3Mesh : public R3Shape
{
    R3Shape::Type GetType(void) { return R3Shape::MESH; }
    const R3Box BBox(void) const { return bbox; }
...
inline int R3Mesh::NVertices(void) const
{
...
inline R3MeshVertex *R3Mesh::Vertex(int k) const
{
...
inline int R3Mesh::NFaces(void) const
{
...
inline R3MeshFace *R3Mesh::Face(int k) const
{
