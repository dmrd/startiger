...
R3Plane::R3Plane(void)
{
}



R3Plane::R3Plane(const R3Plane& plane) :
    v(plane.v), 
    d(plane.d)
{
}
...
R3Plane::R3Plane(double a, double b, double c, double d) :
    v(a, b, c), 
    d(d)
{
}
...
R3Plane::R3Plane(const double a[4]) :
    v(&a[0]), 
    d(a[3])
{
}
...
R3Plane::R3Plane(const R3Vector& normal, double d) :
    v(normal),
    d(d)
{
}
...
R3Plane::R3Plane(const R3Point& point, const R3Vector& normal)
{
...
R3Plane::R3Plane(const R3Point& point, const R3Line& line)
{
...
R3Plane::R3Plane(const R3Point& point, const R3Vector& vector1, const R3Vector& vector2)
{
...
R3Plane::R3Plane(const R3Point& point1, const R3Point& point2, const R3Point& point3)
{
...
R3Plane::R3Plane(const R3Point *points, int npoints)
{
...
R3Point R3Plane::Point (void) const
{
...
void R3Plane::Mirror(const R3Plane& plane)
{
    // Mirror plane ???
    R3Point p = Point();
    p.Mirror(plane);
...
void R3Plane::Reposition(const R3Point& point)
{
    // Move plane
    d = -(v[0]*point[0] + v[1]*point[1] + v[2]*point[2]);
}
...
void R3Plane::Translate(const R3Vector& vector) 
{
...
void R3Plane::Transform (const R3Matrix& matrix)
{
    // Transform plane
    R3Point p = Point();
...
void R3Plane::InverseTransform (const R3Matrix& matrix)
{
...
void R3Plane::Reset(const R3Point& point, const R3Vector& normal) 
{
    // Reset plane
    v = normal;
    d = -(normal[0]*point[0] + normal[1]*point[1] + normal[2]*point[2]);
