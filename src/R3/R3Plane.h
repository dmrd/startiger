...
inline double R3Plane::operator[](int i) const
{
    assert ((i>=0) && (i<=3));
    return ((i == 3) ? d : v[i]);
}
...
inline double& R3Plane::operator[](int i) 
{
    assert ((i>=0) && (i<=3));
    return ((i == 3) ? d : v[i]);
}
...
inline double R3Plane::A(void) const
{
    return v[0];
}
...
inline double R3Plane::B(void) const
{
    return v[1];
}
...
inline double R3Plane::C(void) const
{
    return v[2];
}
...
inline double R3Plane::D(void) const
{
    return d;
}
...
inline const R3Vector& R3Plane::Normal(void) const
{
    return v;
}
...
inline bool R3Plane::IsZero(void) const
{
...
inline bool R3Plane::operator==(const R3Plane& plane) const
{
...
inline R3Plane R3Plane::operator-(void) const
{
...
inline void R3Plane::Align(const R3Vector& normal) 
{
