...
R3Point::R3Point(void)
{
}



R3Point::R3Point(double x, double y, double z)
{
...
R3Point::R3Point(const R3Point& point)
{
    // Initialize coordinates
    v[0] = point.v[0]; 
    v[1] = point.v[1]; 
...
R3Point::R3Point(const double array[3])
{
    // Initialize coordinates
    v[0] = array[0]; 
    v[1] = array[1]; 
...
R3Vector R3Point::Vector(void) const
{
...
void R3Point::Translate (const R3Vector& vector) 
{
...
void R3Point::Project(const R3Line& line)
{
...
void R3Point::Project(const R3Plane& plane)
{
...
void R3Point::Mirror(const R3Plane& plane)
{
...
void R3Point::Rotate(const R3Vector& axis, double theta)
{
...
void R3Point::Rotate(const R3Line& axis, double theta)
{
...
void R3Point::Transform(const R3Matrix& matrix)
{
    // Transform point
    *this = matrix * (*this);
}
...
void R3Point::InverseTransform(const R3Matrix& matrix)
{
...
R3Point& R3Point::operator=(const R3Point& point)
{
    // Assign coordinates
    v[0] = point.v[0];
    v[1] = point.v[1];
...
R3Point& R3Point::operator+=(const R3Vector& vector)
{
...
R3Point& R3Point::operator*=(const double a)
{
...
void R3Point::Print(FILE *fp) const
{
