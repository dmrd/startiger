...
inline double R3Point::X (void) const
{
    // Return X coordinate
    return(v[0]);
}
...
inline double R3Point::Y (void) const
{
    // Return y coordinate
    return(v[1]);
}
...
inline double R3Point::Z (void) const
{
    // Return z coordinate
    return(v[2]);
}
...
inline double R3Point::operator[](int dim) const
{
...
inline double& R3Point::operator[] (int dim) 
{
...
inline bool R3Point::IsZero(void) const
{
...
inline void R3Point::SetX (double x) 
{
    // Set X coord
    v[0] = x;
}
...
inline void R3Point::SetY (double y) 
{
    // Set Y coord
    v[1] = y;
}
...
inline void R3Point::SetZ (double z) 
{
    // Set Z coord
    v[2] = z;
}
...
inline void R3Point::SetCoord (int dim, double coord) 
{
...
inline void R3Point::Reset(double x, double y, double z) 
{
    // Set all coords
    v[0] = x;
    v[1] = y;
...
inline bool R3Point::operator==(const R3Point& point) const
{
