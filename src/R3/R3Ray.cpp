...
R3Ray::R3Ray(const R3Point& point, const R3Vector& vector, bool normalized) :
...
R3Ray::R3Ray(const R3Point& point1, const R3Point& point2) :
    line(point1, point2)
{
}
...
R3Ray::R3Ray(double x1, double y1, double z1, double x2, double y2, double z2) :
...
const R3Point R3Ray::Point(double t) const
{
...
const double R3Ray::T(const R3Point& point) const
{
...
void R3Ray::Transform (const R3Matrix& matrix)
{
    // Transform line
...
void R3Ray::InverseTransform (const R3Matrix& matrix)
{
    // Transform line
...
void R3Ray::Print(FILE *fp) const
{
