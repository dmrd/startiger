...
inline const R3Point& R3Ray::Start(void) const
{
...
inline const R3Vector& R3Ray::Vector(void) const
{
...
inline const R3Line& R3Ray::Line(void) const
{
...
inline const bool R3Ray::IsZero (void) const
{
...
inline const bool R3Ray::operator==(const R3Ray& ray) const
{
...
inline R3Ray R3Ray::operator-(void) const
{
...
inline void R3Ray::Mirror(const R3Plane& plane)
{
...
inline void R3Ray::Translate(const R3Vector& vector)
{
...
inline void R3Ray::Reposition(const R3Point& point)
{
    // Set endpoint of ray
...
inline void R3Ray::Align(const R3Vector& vector, bool normalized)
{
    // Set vector of ray
...
inline void R3Ray::Reset(const R3Point& point, const R3Vector& vector, bool normalized)
{
    // Reset ray
