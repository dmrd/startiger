...
R3Segment::R3Segment(void)
{
}



R3Segment::R3Segment(const R3Segment& segment) :
    ray(segment.ray),
    end(segment.end),
...
R3Segment::R3Segment(const R3Point& point, const R3Vector& vector) :
    end(point + vector)
{
    R3Vector v(vector);
    length = v.Length();
...
R3Segment::R3Segment(const R3Point& point1, const R3Point& point2) :
    end(point2)
{
...
R3Segment::R3Segment(double x1, double y1, double z1, double x2, double y2, double z2) :
    end(x2, y2, z2)
{
    R3Point p1(x1, y1, z1);
    R3Point p2(x2, y2, z2);
...
const R3Point R3Segment::Point(double t) const
{
...
const R3Point R3Segment::Midpoint(void) const
{
...
const R3Box R3Segment::BBox(void) const
{
    // Return bounding box 
...
const double R3Segment::T(const R3Point& point) const
{
...
const bool R3Segment::IsPoint(void) const
{
...
void R3Segment::Reposition(int k, const R3Point& point)
{
...
void R3Segment::Align(const R3Vector& vector)
{
...
void R3Segment::Transform(const R3Matrix& matrix)
{
    // Transform segment
...
void R3Segment::InverseTransform (const R3Matrix& matrix)
{
    // Transform segment
...
void R3Segment::Translate(const R3Vector& vector)
{
...
void R3Segment::Reset(const R3Point& point1, const R3Point& point2)
{
    // Reset segment
...
const bool R3Segment::operator==(const R3Segment& segment) const
{
...
void R3Segment::Draw(void) const
{
    // Draw segment
...
void R3Segment::Print(FILE *fp) const
{
    // Print end points
