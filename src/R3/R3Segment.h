...
class R3Segment : public R3Shape
{
    public:
        R3Shape::Type GetType(void) { return R3Shape::SEGMENT; }
...
inline const R3Point& R3Segment::Start (void) const
{
...
inline const R3Point& R3Segment::End (void) const
{
...
inline const R3Vector& R3Segment::Vector(void) const
{
...
inline const R3Point& R3Segment::operator[] (int k) const
{
...
inline const R3Point R3Segment::Point (int k) const
{
    // Return kth endpoint of segment
    return (*this)[k];
}
...
inline const R3Ray& R3Segment::Ray(void) const
{
...
inline const R3Line& R3Segment::Line(void) const
{
...
inline const R3Point R3Segment::Centroid(void) const
{
...
inline const double R3Segment::Length(void) const
{
...
inline const bool R3Segment::operator!=(const R3Segment& segment) const
{
...
inline R3Segment R3Segment::operator-(void) const
{
...
inline void R3Segment::Mirror(const R3Plane& plane)
{
