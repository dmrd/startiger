...
R3Sphere::R3Sphere(void)
{
}



R3Sphere::R3Sphere(const R3Sphere& sphere) :
...
R3Sphere::R3Sphere(const R3Point& center, double radius) :
    center(center),
    radius(radius)
{
}
...
double R3Sphere::Area(void) const
{
...
double R3Sphere::Volume(void) const
{
...
const R3Box R3Sphere::BBox(void) const
{
...
void R3Sphere::Translate(const R3Vector& vector)
{
    // Move sphere center
...
void R3Sphere::Reposition(const R3Point& center)
{
    // Set sphere center
    this->center = center;
}
...
void R3Sphere::Resize(double radius) 
{
    // Set sphere radius
    this->radius = radius;
}
...
void R3Sphere::Outline(void) const
{
...
void R3Sphere::Print(FILE *fp) const
{
