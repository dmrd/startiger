...
R3Vector::R3Vector(void)
{
}



R3Vector::R3Vector(double x, double y, double z)
{
...
R3Vector::R3Vector(const R3Vector& vector)
{
    // Initialize coordinates
    v[0] = vector.v[0]; 
    v[1] = vector.v[1]; 
...
R3Vector::R3Vector(double pitch, double yaw)
{
    // Initialize coordinates
...
R3Vector::R3Vector(const double array[3])
{
    // Initialize coordinates
    v[0] = array[0]; 
    v[1] = array[1]; 
...
double R3Vector::Dot(const R3Vector& vector) const
{
...
void R3Vector::Cross(const R3Vector& vector)
{
...
void R3Vector::Rotate(const R3Vector& axis, double theta)
{
...
void R3Vector::Project(const R3Vector& vector)
{
...
void R3Vector::Project(const R3Plane& plane) 
{
    // Project onto plane
...
void R3Vector::Mirror(const R3Plane& plane)
{
...
void R3Vector::Transform(const R3Matrix& matrix)
{
    // Transform vector
    *this = matrix * (*this);
}
...
void R3Vector::InverseTransform(const R3Matrix& matrix)
{
...
R3Vector& R3Vector::operator=(const R3Vector& vector)
{
...
R3Vector& R3Vector::operator*=(const double a)
{
...
R3Vector operator+(const R3Vector& vector1, const R3Vector& vector2)
{
...
R3Vector operator*(const double a, const R3Vector& vector)
{
...
R3Vector operator*(const R3Vector& vector, const double a)
{
...
void R3Vector::Print(FILE *fp) const
{
