...
inline double R3Vector::X(void) const
{
    // Return X coordinate
    return (v[0]);
}
...
inline double R3Vector::Y(void) const
{
    // Return Y coordinate
    return (v[1]);
}
...
inline double R3Vector::Z(void) const
{
    // Return Z coordinate
    return (v[2]);
}
...
inline double R3Vector::operator[](int dim) const
{
...
inline double& R3Vector::operator[](int dim) 
{
...
inline bool R3Vector::IsZero(void) const
{
...
inline bool R3Vector::IsNormalized(void) const
{
...
inline double R3Vector::Length(void) const
{
...
inline R3Point R3Vector::Point(void) const
{
...
inline int R3Vector::MinDimension(void) const
{
...
inline int R3Vector::MaxDimension(void) const
{
    // Return principal dimension of vector
    if (fabs(v[0]) >= fabs(v[1])) {
        if (fabs(v[0]) >= fabs(v[2])) return R3_X;
...
inline bool R3Vector::operator==(const R3Vector& vector) const
{
...
inline void R3Vector::SetX(double x) 
{
    // Set X coord
    v[0] = x;
}
...
inline void R3Vector::SetY(double y) 
{
    // Set Y coord
    v[1] = y;
}
...
inline void R3Vector::SetZ(double z) 
{
    // Set Z coord
    v[2] = z;
}
...
inline void R3Vector::SetCoord(int dim, double coord) 
{
...
inline void R3Vector::Reset(double x, double y, double z) 
{
    // Set all coords
    v[0] = x;
    v[1] = y;
